#ifndef PROGRAM6_PIXEL_H
#define PROGRAM6_PIXEL_H
...
class Pixel {  
    ...
    Pixel (char value = ' ', Color color = Color::BLACK) : _value(value), _color(color) {
    }
    ...
    unsigned char color() const {
        return static_cast<unsigned char>(_color);
    }
...
class PixelBuffer {
    ...
    void set(array<size_t, 2> pos, const Pixel &pixel) {
    ...
    array<size_t, 2> random_pos() const {
